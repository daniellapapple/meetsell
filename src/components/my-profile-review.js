          ...
          <div className="profile-review-wrap-item">
            ...
            <Col md={ 9 }>
              <div className="profile-review-item-right-wrap">
                ...
                <div className="profile-review-item-rating">
                  <fieldset className="rating">
                    <input type="radio" id="s5" name="ratin" value="5" /><label className = "full" htmlFor="s5" title="Awesome - 5 stars"></label>
                    <input type="radio" id="s4half" name="ratin" value="4 and a half" /><label className="half" htmlFor="s4half" title="Pretty good - 4.5 stars"></label>
                    <input type="radio" id="s4" name="ratin" value="4" /><label className = "full" htmlFor="s4" title="Pretty good - 4 stars"></label>
                    <input type="radio" id="s3half" name="ratin" value="3 and a half" /><label className="half" htmlFor="s3half" title="Meh - 3.5 stars"></label>
                    <input type="radio" id="s3" name="ratin" value="3" /><label className = "full" htmlFor="s3" title="Meh - 3 stars"></label>
                    <input type="radio" id="s2half" name="ratin" value="2 and a half" /><label className="half" htmlFor="s2half" title="Kinda bad - 2.5 stars"></label>
                    <input type="radio" id="s2" name="ratin" value="2" /><label className = "full" htmlFor="s2" title="Kinda bad - 2 stars"></label>
                    <input type="radio" id="s1half" name="ratin" value="1 and a half" /><label className="half" htmlFor="s1half" title="Meh - 1.5 stars"></label>
                    <input type="radio" id="s1" name="ratin" value="1" /><label className = "full" htmlFor="s1" title="Sucks big time - 1 star"></label>
                    <input type="radio" id="shalf" name="ratin" value="half" /><label className="half" htmlFor="shalf" title="Sucks big time - 0.5 stars"></label>
                  </fieldset>
                </div>
                <div className="profile-review-other-comment">
                  <p>Barangnya oke..sesuai dengan deskripsi di website.. pengiriman juga cepat. rekomende seller nih..besok beli lagi!</p>
