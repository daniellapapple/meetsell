...
class FaqPembeli extends Component {
  ...
  render() {
    return (
      <div className="faq-pembeli">
        <div className="my-profile-pengaturan-top">
          <Col md={ 6 } sm={ 6 } xs={ 4 }>
            <p className="faq-content-title">Pembeli</p>
          </Col>
        ...
        <div className="faq-pembeli-body">
          <p>
