...
class FaqPenjual extends Component {
  ...
  render() {
    return (
      <div className="faq-penjual">
        <div className="my-profile-pengaturan-top">
          <Col md={ 6 } sm={ 6 } xs={ 4 }>
            <p className="faq-content-title">Penjual</p>
          </Col>
        ...
        <div className="faq-penjual-body">
          <p>
